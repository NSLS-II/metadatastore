...
"""
####Create a new header and beamline configuration######
...
print search(header_id=1903, contents=True)

print search(start_time={'start': datetime.datetime(2013, 6, 13, 17, 51, 21, 987000),
