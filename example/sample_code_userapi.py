...
create(header={'scan_id': s_id, 'tags': ['CSX_Experiment1', 'CSX_Experiment2'], 'header_owner': 'arkilic'})
...
mtr3 = random.randint(0, 90)
data_dict = {'list_of_1k': some_list, 'motor1': random.randint(0, 90), 'motor2': random.randint(0, 90),
                     'motor3': mtr3, 'motor4': random.randint(0, 90), 'motor5': random.randint(0, 90)}
...
print 'Here are the data keys for recent insert', a['header_0']['event_descriptors']['event_descriptor_0']['data_keys']
...
res = search(owner='arkilic', event_classifier={'data.motor3': mtr3}, data=True)

for entry in res:
    print res[entry]['event_descriptors']['event_descriptor_0']['events']


print 'here is the new query'
res2 = search(owner='*', data=True)
print res2['header_0']['event_descriptors']