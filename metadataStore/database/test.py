...
for i in xrange(800):
    event = record_event(event_id=i, header_id=438, start_time=datetime.datetime(2014,10,1),
...
print 'Here is the stuff i care about'
some_doc = {'name': 'Besikta24s', 'dob': 'is53tanbul'}
event.some_doc = some_doc
print event.save(write_concern={'w': 1})
